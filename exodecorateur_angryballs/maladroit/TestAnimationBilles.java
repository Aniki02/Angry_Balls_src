...
Bille bille1 = new PasseMuraille(new BilleNue(centreBille1, rayonBille1, vitesseBille1, Color.blue));
...
Bille bille2 = new PasseMuraille(new BilleNue(centreBille2, rayonBille2, vitesseBille2, Color.blue));
billes.add(bille2);
