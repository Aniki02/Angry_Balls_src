...
/**
 * responsable de l'animation des billes, c-a-d responsable du mouvement de la liste des billes. met perpetuellement a jour les billes. 
 * gere le delai entre 2 mises a jour (deltaT) et previent la vue responsable du dessin des billes qu'il faut mettre a jour la scene
 * 
...
try
    ...
    while (!Thread.interrupted())                           // gestion du mouvement
        {
        //deltaT = COEFF*minRayons2/(1+maxVitessesCarrees(billes));       // mise a jour deltaT. L'addition + 1 est une astuce pour eviter les divisions par zero
